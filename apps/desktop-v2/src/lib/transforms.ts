...
export function transformToSharedReport(raw: VehicleReport): AppReport {
  ...
  return {
    ...
    daysOnLot: v.daysOnLot as number | null,
    ...
    score: 8.2,
    verdict: raw.verdict ?? "",
    aiSummary: raw.summary as string | null,
    stats: raw.stats,
    ...
    verdictTab: {
      scoreBreakdown: [
        { id: "1", label: "Price vs. market", description: "2.8% below fair price", delta: 0.2, icon: "TrendingDown" },
        { id: "2", label: "Accident history", description: "No reported accidents", delta: -0.2, icon: "ShieldCheck" },
        { id: "3", label: "Odometer", description: "Miles consistent with age", delta: 0.2, icon: "Gauge" },
        { id: "4", label: "Number of owners", description: "2 owners in 1 year (normal for auction)", delta: 0.2, icon: "Users" },
