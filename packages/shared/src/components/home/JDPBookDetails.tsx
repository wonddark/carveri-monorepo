  ...
  return (
    <Dialog>
      ...
      <DialogContent showCloseButton={false} className="p-0">
        <div className="relative bg-indigo-50 px-5 pt-5 pb-4 md:rounded-t-2xl">
          <DialogClose asChild>
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              ...
              <div className="text-3xl font-bold text-gray-900">$20,075</div>
            </div>
        ...
        <div className="space-y-5 px-5 py-4">
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2">
                <span className="text-sm text-gray-700">Equipment Adj.</span>
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed text-gray-500">
              Trade-in and retail values based on dealer transaction data and
              wholesale auction results nationwide.
            </p>
          </div>
