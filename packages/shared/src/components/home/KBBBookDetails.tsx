  ...
  return (
    <Dialog>
      ...
      <DialogContent showCloseButton={false} className="p-0">
        <div className="relative bg-blue-50 px-5 pt-5 pb-4 md:rounded-t-2xl">
          <DialogClose asChild>
          ...
          <div className="flex items-center gap-3">
            ...
            <div data-loc="client/src/components/BookDetailModal.tsx:78">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div data-loc="client/src/components/BookDetailModal.tsx:84">
              <div className="text-xs font-medium text-gray-400">
                Adjusted Value
              </div>
              <div className="text-3xl font-bold text-gray-900">$22,310</div>
            </div>
        ...
        <div className="space-y-5 px-5 py-4">
          <div data-loc="client/src/components/BookDetailModal.tsx:156">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2">
                <span className="text-sm text-gray-700">AWD Premium</span>
                <span className="text-sm font-semibold text-emerald-600">
                  +$520
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div data-loc="client/src/components/BookDetailModal.tsx:174">
            <div className="mb-1.5 text-xs font-semibold text-gray-700">
              Methodology
            </div>
            <p className="text-xs leading-relaxed text-gray-500">
              Retail fair market value based on actual dealer transactions,
              private party sales, and trade-in data.
            </p>
          </div>
