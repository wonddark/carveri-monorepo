    ...
    <div className="space-y-3">
      ...
      <div className="mb-4 flex items-center gap-1">
        <button
          ...
          className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-400 disabled:pointer-events-none disabled:opacity-30"
        >
          <ChevronLeft size={14} />
        </button>
      ...
      {activeIdx === 4 && <ServiceSubtab service={report.historyTab.service} />}
