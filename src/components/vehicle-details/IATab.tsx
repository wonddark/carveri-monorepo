      ...
      <TabsContent value="veredicto">
        <div className="verdict-card mb-3 rounded-2xl border border-green-200 bg-linear-to-br from-[#f0fdf4] to-[#ecfdf5] p-5 text-center">
          ...
          <div className="verdict-summary mt-3 text-[13px] leading-relaxed text-[#555]">
            ...
            refleja ese descuento. Recomendamos inspección física enfocada en la
            zona frontal antes de cerrar la compra.
          </div>
        </div>
        ...
        <Card className="mb-3 rounded-2xl border-[#e8e8ea]">
          ...
          <CardContent className="space-y-2 p-4 pt-2">
            <Argument
              ...
              text={
                <span>
                  <strong>Historial de accidente:</strong> El Carfax reporta un
                  accidente frontal moderado, lo cual reduce el valor de reventa
                  entre $3,000 y $5,000 según los libros.
                </span>
              }
            />
            <Argument
              ...
              text={
                <span>
                  <strong>Tendencia de mercado:</strong> Los precios del X5 2024
                  han bajado 7.2% en los últimos 6 meses. Esperar 30 días más
                  podría significar $500-$1,000 menos.
                </span>
              }
            />
            <Argument
              ...
              text={
                <span>
                  <strong>Días en lote:</strong> Este vehículo lleva 34 días en
                  el lote. El promedio para este modelo es 22 días. El dealer
                  tiene presión de moverlo.
                </span>
              }
            />
            <Argument
              ...
              text={
                <span>
                  ...
                  similares dentro de 40 millas por menos dinero, incluyendo uno
                  sin accidentes por $51,900.
                </span>
              }
            />
          </CardContent>
...
const FactorRow: React.FC<{
...
}> = ({ name, note, score, color, renderIcon }) => (
  <div className="border-border flex items-center justify-between border-b py-3 last:border-none lg:grid lg:grid-cols-[1fr_auto_auto] lg:gap-4">
    <div className="flex items-center gap-2">
      ...
      >
        {renderIcon(cn("h-3.5 w-3.5", `bg-[${color}]`))}
      </div>
      <div>
